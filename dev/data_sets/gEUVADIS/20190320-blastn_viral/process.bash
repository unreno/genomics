...
#ls *fasta | parallel --no-notice --joblog ~/parallel.1.log -j20 blastn -query {} -num_threads 1 -outfmt 6 -db viral.masked -out {}.viral.masked.1.txt 2\> {}.viral.masked.1.err &

#ls /raid/data/raw/gEUVADIS/*fastq.gz | parallel --no-notice --joblog ./parallel.joblog -j20 ./process.bash &
...
#	else
#		echo "Blasting ${fasta} creating ${blast_out}" >> ${base}.log
#		blastn -query ${fasta} -num_threads 2 -outfmt 6 -db viral.masked -out ${blast_out} 2> ${blast_err}
#		chmod a-w ${blast_out}
#	fi
