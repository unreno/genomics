...
{ pos[$1":"$2":"$3":"$4]++ }
END{ print_record() }' <( zcat tumor_only.sorted.uniq.pent.txt.gz ) TCGA*.snps.txt | gzip > tumor_only.summary_table.pent.raw.csv.gz


datamash transpose -t, < <( zcat tumor_only.summary_table.pent.raw.csv.gz ) | gzip > tumor_only.summary_table.pent.csv.gz
